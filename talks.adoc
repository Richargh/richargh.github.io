...
* link:https://jsheroes.io/#:~:text=Forensic[JsHeroes 2026 🇬🇧] (25min) | link:https://speakerdeck.com/richargh/making-sense-of-frontend-code-with-forensic-techniques-v1-s-at-jsheroes-2026[Slides]
