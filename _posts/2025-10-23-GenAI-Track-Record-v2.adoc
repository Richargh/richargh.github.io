...
// How AI Destroys Institutions 8 Dec 2025 https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5870623

// Code for Machines, Not Just Humans: Quantifying AI-Friendliness with Code Health Metrics [Adam Tornhill] 5 Jan 2026 https://arxiv.org/pdf/2601.02200

// Can you prove AI ROI in Software Eng? (Stanford 120k Devs Study) – Yegor Denisov-Blanch, Stanford Dec11 2025 https://www.youtube.com/watch?app=desktop&v=JvosMkuNxF8

// How AI assistance impacts the formation of coding skills 29 Jan 2026 https://www.anthropic.com/research/AI-assistance-coding-skills

// Then end of thinking Sep 25 2025 https://www.derekthompson.org/p/the-end-of-thinking

// AI startup Anthropic agrees to pay $1.5bn to settle book piracy lawsuit 5 Sep 2025 https://www.theguardian.com/technology/2025/sep/05/anthropic-settlement-ai-book-lawsuit

// Introducing OpenClaw 29 Jan 2026 https://openclaw.ai/blog/introducing-openclaw

// OpenAI says prompt injections that can trick AI browsers like ChatGPT Atlas may never be fully ‘solved’—experts say risks are ‘a feature not a bug’ Dec 25, 2025 https://fortune.com/2025/12/23/openai-ai-browser-prompt-injections-cybersecurity-hackers/

// Adversarial Poetry as a Universal Single-Turn Jailbreak Mechanism in Large Language Models https://arxiv.org/html/2511.15304v1

// Speed at the Cost of Quality: How Cursor AI Increases Short-Term Velocity and Long-Term Complexity in Open-Source Projects 6 Nov 2025 https://arxiv.org/abs/2511.04427

// Firm Data on AI Feb 2026 https://www.nber.org/papers/w34836

// How AI Impacts Skill Formation Feb 2026 https://arxiv.org/abs/2601.20245

// System Over Model: Zero-Day Discovery at the Jagged Frontier Apr 2026 https://aisle.com/blog/system-over-model-zero-day-discovery-at-the-jagged-frontier
...
== 2026-05-12 link:https://arxiv.org/abs/2605.07912[Sycophantic AI makes human interaction feel more effortful and less satisfying over time]

* Millions of people now turn to artificial intelligence (AI) systems for personal advice, guidance, and support.
* Such systems can be *sycophantic*, frequently affirming users' views and beliefs.
* Across five preregistered studies (N = 3,075 participants, 12,766 human-AI conversations), including a three-week study with a census-representative U.S. sample, we provide longitudinal experimental evidence that sycophantic AI shifts how users approach their closest relationships.
* We show that sycophantic AI immediately delivers the emotional and esteem support users typically associate *with close friends and family*.
...
* Overall, our work suggests that sycophantic AI delivers what people have always sought from close others, the experience of being seen and understood, but without the work that produces it:
** the time to explain and listen,
** the risk of opening up,
** and the friction and empathic effort of bridging disparate experiences.
* When feeling understood becomes the default of every interaction, the human relationships that still require the work may, over time, come to feel like *insufficient versions of what AI systems readily provide*.

== 2026-04 link:https://rdi.berkeley.edu/blog/trustworthy-benchmarks-cont/[How We Broke Top AI Agent Benchmarks: And What Comes Next]
...
// == 2026-02-20 link:https://cloud.google.com/blog/products/ai-machine-learning/gemini-3-1-pro-on-gemini-cli-gemini-enterprise-and-vertex-ai[Introducing Gemini 3.1 Pro on Google Cloud]
//
// Company: Google DeepMind +
// Headquarters: London, England +
// Previous: <<gemini-3-launch>> +

// [#sonnet-4-6-launch]
// == 2026-02-17 link:https://www.anthropic.com/news/claude-sonnet-4-6[Introducing Claude Sonnet 4.6]
//
// Company: Anthropic PBC +
// Headquarters: San Francisco, California, U.S. +
// Previous: <<sonnet-4-5-launch>>

[#semantic-ablation]
== 2026-02-16 link:https://www.theregister.com/2026/02/16/semantic_ablation_ai_writing/[Semantic ablation: Why AI writing is so generic, boring, and dangerous]
...
* The AI identifies high-entropy clusters – the precise points where unique insights and "blood" reside – and systematically replaces them with the most probable, generic token sequences.
...
// == 2026-02-16 link:https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-deep-think/[Gemini 3 Deep Think: Advancing science, research and engineering]
//
// Company: Google DeepMind +
// Headquarters: London, England +
// Previous: <<gemini-3-launch>> +
...
// [#qwen-3-5-launch]
// == 2026-02-02 link:https://qwen.ai/blog?id=qwen3.5[Qwen3.5: Towards Native Multimodal Agents]
//
// Company: Alibaba Cloud +
// Headquarters: Singapore

// [#gpt-5-3-codex-spark-launch]
// == 2026-02-12 link:https://openai.com/index/introducing-gpt-5-3-codex-spark/[Introducing GPT‑5.3‑Codex‑Spark]
//
// Company: OpenAI +
// Headquarters: San Francisco, California, U.S. +
// Previous: <<gpt-5-3-codex-launch>>

// [#glm-5-launch]
// == 2026-02-12 link:https://z.ai/blog/glm-5[GLM-5: From Vibe Coding to Agentic Engineering]
//
// Company: z.ai +
// Headquarters: Beijing, China +
// Previous: <<glm-4-7-launch>>
//
// * scales from 355B parameters (32B active) to 744B parameters (40B active)
// * increases pre-training data from 23T to 28.5T tokens
// * integrates DeepSeek Sparse Attention (DSA)

// [#gpt-5-3-codex-launch]
// == 2026-02-05 link:https://openai.com/index/introducing-gpt-5-3-codex/[Introducing GPT‑5.3‑Codex]
//
// Company: OpenAI +
// Headquarters: San Francisco, California, U.S. +
// Previous: <<gpt-5-2-codex-launch>>

// [#opus-4-6-launch]
// == 2026-02-05 link:https://www.anthropic.com/news/claude-opus-4-6[Introducing Claude Opus 4.6]
//
// Company: Anthropic PBC +
// Headquarters: San Francisco, California, U.S. +
// Previous: <<opus-4-5-launch>>

// [#qwen-coder-next-launch]
// == 2026-02-02 link:https://qwen.ai/blog?id=qwen3-coder-next[Qwen3-Coder-Next: Pushing Small Hybrid Models on Agentic Coding]
//
// Company: Alibaba Cloud +
// Headquarters: Singapore

// [#glm-4-7-launch]
// == 2025-12-22 link:https://z.ai/blog/glm-4.7[GLM-4.7: Advancing the Coding Capability]
//
// Company: z.ai +
// Headquarters: Beijing, China +
// Previous: <<glm-4-6-launch>>

[#agent-skills-open-standard]
== 2025-12-18 link:https://agentskills.io/home[Agent Skills becomes an open Standard]

* Agent Skills are folders of instructions, scripts, and resources that agents can discover and use to do things more accurately and efficiently.

// [#gpt-5-2-codex-launch]
// == 2026-02-05 link:https://openai.com/index/introducing-gpt-5-2-codex/[Introducing GPT‑5.2‑Codex]
//
// Company: OpenAI +
// Headquarters: San Francisco, California, U.S. +
// Previous: <<gpt-5-1-codex-max-launch>>

// [#gemini-3-flash-launch]
// == 2025-12-17 link:https://blog.google/products-and-platforms/products/gemini/gemini-3-flash/[Gemini 3 Flash: frontier intelligence built for speed]
//
// Company: Google DeepMind +
// Headquarters: London, England +
// Previous: <<gemini-3-launch>> +
...
// == 2025-12-16 link:https://openai.com/index/new-chatgpt-images-is-here/[The new ChatGPT Images is here]

// [#gpt-5-2-launch]
// == 2025-12-11 link:https://openai.com/index/introducing-gpt-5-2/[Introducing GPT‑5.2]
//
// Company: OpenAI +
// Headquarters: San Francisco, California, U.S. +
// Previous: <<gpt-5-1-launch>>

[#mcp-linux-foundation]
== 2025-12-09 link:https://blog.modelcontextprotocol.io/posts/2025-12-09-mcp-joins-agentic-ai-foundation/[MCP joins the Agentic AI Foundation (Linux Foundation)]

* Anthropic is donating MCP to the Agentic AI Foundation, a directed fund under the Linux Foundation.
* MCP will become a founding project of the newly created foundation.

// [#devstral-2-launch]
// == 2025-12-08 link:https://mistral.ai/news/devstral-2-vibe-clip[Devstral2]
//
// Company: Mistral AI +
// Headquarters: Paris, France
//
// * State-of-the-art, open-source agentic coding models and CLI agent.
// * Devstral 2 (123B) and Devstral Small 2 (24B). Devstral 2 ships under a modified MIT license, while Devstral Small 2 uses Apache 2.0. B
// * We are also introducing Mistral Vibe, a native CLI built for Devstral that enables end-to-end code automation.

// [#mistral-3-launch]
// == 2025-12-02 link:https://mistral.ai/news/mistral-3[Introducing Mistral 3]
//
// Company: Mistral AI +
// Headquarters: Paris, France

// [#deepseek-3-2-launch]
// == 2025-12-01 link:https://api-docs.deepseek.com/news/news251201[DeepSeek-V3.2 Release]
//
// Company: DeepSeek +
// Headquarters: Hangzhou, Zhejiang, China +
// Previous: <<deepseek-3-1-launch>>

[#mcp-v4]
== 2025-11-25 link:https://modelcontextprotocol.io/specification/2025-11-25[MCP Specification 2025-11-25]

Previous: <<mcp-v3>>

// [#opus-4-5-launch]
// == 2025-11-24 link:https://www.anthropic.com/news/claude-opus-4-5[Introducing Claude Opus 4.5]
//
// Company: Anthropic PBC +
// Headquarters: San Francisco, California, U.S. +
// Previous: <<sonnet-4-5-launch, Sonnet 4.5>> and <<claude-4-launch, Opus 4.0>>

// [#gpt-5-1-codex-max-launch]
// == 2025-11-19 link:https://openai.com/index/gpt-5-1-codex-max/[Building more with GPT-5.1-Codex-Max]
//
// Company: OpenAI +
// Headquarters: San Francisco, California, U.S. +
// Previous: <<gpt-5-codex-launch>>

// [#gemini-3-launch]
// == 2025-11-18 link:https://blog.google/products/gemini/gemini-3/#note-from-ceo[A new era of intelligence with Gemini 3]
//
// Company: Google DeepMind +
// Headquarters: London, England +
// Previous: <<gemini-2-5-launch>> +

// [#gpt-5-1-launch]
// == 2025-11-12 link:https://openai.com/index/gpt-5-1/[GPT-5.1: A smarter, more conversational ChatGPT]
//
// Company: OpenAI +
// Headquarters: San Francisco, California, U.S. +
// Previous: <<gpt-5-launch>>

== 2025-10-31 link:https://ai.meta.com/blog/practical-ai-agent-security/[Agents Rule of Two: A Practical Approach to AI Agent Security]
...
[#sora2-launch]
== 2025-10-30 link:https://openai.com/index/sora-2/[Sora 2 is here]

Company: OpenAI +
Headquarters: San Francisco, California, U.S.

// [#minimax-m2-launch]
// == 2025-10-27 link:https://www.minimax.io/news/minimax-m2[MiniMax M2 & Agent]
//
// Company: MiniMax +
// Headquarters: Shanghai, China
//
// * MiniMax M2, a model born for Agents and code.
// * At only 8% of the price of Claude Sonnet and twice the speed

== 2025-10-22 link:https://www.anildash.com//2025/10/22/atlas-anti-web-browser/[ChatGPT's Atlas: The Browser That's Anti-Web]

. <<atlas-launch, Atlas>> substitutes its own AI-generated content for the web, but it looks like it's showing you the web
...
* [A couple of weeks after Perplexity's comet browser was <<comet-launch, available to all>>]
...
== 2025-10-10 link:https://arxiv.org/abs/2510.09023[The Attacker Moves Second: Stronger Adaptive Attacks Bypass Defenses Against Llm Jailbreaks and Prompt Injections]

* Current defenses against jailbreaks and prompt injections (which aim to prevent an attacker from eliciting harmful knowledge or remotely triggering malicious actions, respectively) are typically evaluated either against a static set of harmful attack strings [a fixed dataset of known
jailbreak or prompt injection prompts], or against computationally weak optimization methods that were not designed with the defense in mind. We argue that this evaluation process is flawed
...
// [#glm-4-6-launch]
// == 2025-09-30 link:https://z.ai/blog/glm-4.6[GLM-4.6: Advanced Agentic, Reasoning and Coding Capabilities]
//
// Company: z.ai +
// Headquarters: Beijing, China +
// Previous: <<glm-4-5-launch>>
//
...
* [Alternative to <<kiro-preview, AWS Kiro>>]
...
// [#deepseek-3-1-launch]
// == 2025-08-21 link:https://api-docs.deepseek.com/news/news250821[DeepSeek-V3.1 Release]
//
// Company: DeepSeek +
// Headquarters: Hangzhou, Zhejiang, China +
// Previous: <<deepseek-r1-launch>>
//
...
Company: OpenAI +
Headquarters: San Francisco, California, U.S. +
Previous: <<gpt-o-3-launch>>

// [#claude-4-1-opus-launch]
...
// [#glm-4-5-launch]
// == 2025-07-28 link:https://z.ai/blog/glm-4.5[GLM-4.5: Reasoning, Coding, and Agentic Abililties]
//
// Company: z.ai +
// Headquarters: Beijing, China
//
// * two new GLM family members: GLM-4.5 and GLM-4.5-Air

== 2025-07-25 link:https://arxiv.org/abs/2507.19595[Efficient Attention Mechanisms for Large Language Models: A Survey]
...
* To address this limitation, recent research has introduced two principal categories of efficient attention mechanisms.
** Linear attention methods achieve linear complexity through kernel approximations, recurrent formulations, or fast-weight dynamics, thereby enabling scalable inference with reduced computational overhead.
*** Traditional linear attention methods seek to approximate the softmax-based attention mechanism in a way that scales linearly with sequence length.
*** The core idea is to replace the expensive softmax computation with a kernel-based approximation of the attention weights.
** Sparse attention techniques, in contrast, limit attention computation to selected subsets of tokens based on fixed patterns, block-wise routing, or clustering strategies, enhancing efficiency while preserving contextual coverage.

// [#qwen-3-coder-launch]
// == 2025-07-22 link:https://qwenlm.github.io/blog/qwen3-coder/[Qwen3-Coder: Agentic Coding in the World]
//
// Company: Alibaba Cloud +
// Headquarters: Singapore
...
[#mcp-v3]
== 2025-06-18 link:https://modelcontextprotocol.io/specification/2025-06-18[MCP Specification 2025-06-18]

// [#gemini-2-5-launch]
// == 2025-06-17 link:https://developers.googleblog.com/en/gemini-2-5-thinking-model-updates/[Gemini 2.5: Updates to our family of thinking models]
//
// Company: Google DeepMind +
// Headquarters: London, England
//
// * Gemini 2.5 Pro is generally available and stable
...
== 2025-05-22 link:https://arxiv.org/abs/2505.16957[Invisible Prompts, Visible Threats: Malicious Font Injection in External Resources for Large Language Models]

* We present a systematic investigation of LLM vulnerabilities to hidden adversarial prompts through malicious font injection in external resources like webpages, where attackers manipulate code-to-glyph mapping to inject deceptive content which are invisible to users [undetectable to human readers while being fully accessible to LLMs during content processing]
* We evaluate two critical attack scenarios:
** (1) "malicious content relay" [whether LLMs can process and relay hidden malicious content from external sources to end-users]
** (2) "sensitive data leakage" through MCP-enabled tools
* Our experiments reveal that indirect prompts with injected malicious font can bypass LLM safety mechanisms through external resources, achieving varying success rates based on data sensitivity and prompt design. Our research underscores the urgent need for enhanced security measures in LLM deployments when processing external content.
* Experiments show:
** (1) PDF documents have higher attack success rates (up to 70%) than HTML;
** (2) Strategic prompt placement and higher injection frequency boost success, especially at document starts;
** (3) Newer LLMs are more vulnerable;
** (4) Indirect prompts bypass safety mechanisms, with 100% success for low-sensitivity data (person names and ages) and 30% for high-sensitivity data (phone numbers, geolocation, SSN).
...
Company: Anthropic PBC +
Headquarters: San Francisco, California, U.S. +
Previous: <<claude-sonnet-3-7-launch>>
...
== 2025-05-01 link:https://www.microsoft.com/en-us/research/wp-content/uploads/2025/01/lee_2025_ai_critical_thinking_survey.pdf[The Impact of Generative AI on Critical Thinking: Self-Reported Reductions in Cognitive Effort and Confidence Effects From a Survey of Knowledge Workers]
...
* Quantitatively [...] higher confidence in GenAI is associated with less critical thinking, while higher self-confidence is associated with more critical thinking.
* Generative AI (GenAI) tools [...] are the latest in a long line of technologies that raise questions about their impact on the quality of human thought, a line that includes
** writing (objected to by Socrates)
** printing (objected to by Trithemius)
** calculators (objected to by teachers of arithmetic)
* Such consternation is not unfounded. [...] As Bainbridge [Ironies of Automation] noted, a key irony of automation is that by mechanising routine tasks and leaving exception-handling to the human user, you deprive the user of the routine opportunities to practice their judgement and strengthen their cognitive musculature, leaving them atrophied and unprepared when the exceptions do arise.
* Recent work has motivated the need for critical thinking support in AI-assisted knowledge work. It is motivated primarily by the observation of the tendency of AI-assisted knowledge workflows to be subject to “mechanised convergence” [114], i.e., that users with access to GenAI tools produce a less diverse set of outcomes for the same task, compared to those without.

// [#qwen-3-launch]
// == 2025-04-29 link:https://qwenlm.github.io/blog/qwen3/[Qwen3: Think Deeper, Act Faster]
//
// Company: Alibaba Cloud +
// Headquarters: Singapore
...
[#mcp-v2]
== 2025-03-26 link:https://modelcontextprotocol.io/specification/2025-03-26[MCP Specification 2025-03-26]
...
[quote, Andrej Karpathy - former director of AI & Autopilot Vision at Tesla; co-founded and formerly worked at OpenAI]
____
...
[#deepseek-r1-launch]
== 2025-01-20 link:https://api-docs.deepseek.com/news/news250120[DeepSeek-R1 Release]

Company: DeepSeek +
Headquarters: Hangzhou, Zhejiang, China +
Previous: <<deepseek-3-launch>>
...
== 2025-01-16 link:https://arxiv.org/abs/2501.09223[Foundations of Large Language Models]

* Large language models originated from natural language processing
* We have shifted from training specialized systems from scratch using a large amount of labeled data to a new paradigm of using large-scale pre-training to obtain foundation models, which are then fine-tuned, aligned, and prompted.
* This book aims to outline the basic concepts of large language models and introduce the related techniques.
...
[#deepseek-3-launch]
== 2024-12-26 link:https://api-docs.deepseek.com/news/news1226[Introducing DeepSeek-V3]
...
[#mcp-v1]
== 2024-11-25 link:https://www.anthropic.com/news/model-context-protocol[Introducing the Model Context Protocol]
...
== 2024-07-24 link:https://www.nature.com/articles/s41586-024-07566-y[AI models collapse when trained on recursively generated data]
...
* We refer to this effect as *‘model collapse’* and show that it can occur in LLMs as well as in variational autoencoders (VAEs) and Gaussian mixture models (GMMs) [and Large Language Models (LLMs)].
* We separate two special cases: early model collapse and late model collapse.
** In early model collapse, the model begins losing information about the tails of the distribution
** in late model collapse, the model converges to a distribution that carries little resemblance to the original one, often with substantially reduced variance.
* We build theoretical intuition behind the phenomenon and portray its ubiquity among all learned generative models.
* We also briefly mention two close concepts to model collapse from the existing literature:
** catastrophic forgetting arising in the framework of task-free continual learning
** data poisoning maliciously leading to unintended behaviour.
...
== 2023-07-06 link:https://arxiv.org/abs/2307.03172[Lost in the Middle: How Language Models Use Long Contexts]
...
* Recent improvements in hardware (e.g., faster GPUs with more memory) and algorithms (Dai et al., 2019; Dao et al., 2022; Poli et al., arXiv:2307.03172v3 [cs.CL] 20 Nov 2023 2023; Rubin and Berant, 2023, inter alia) have resulted in language models with larger context windows (e.g., *4096, 32K, and even 100K tokens*), but it remains unclear how these extended-context language models make use of their input contexts when performing downstream tasks.
...
== 2023-04-25 link:https://simonwillison.net/2023/Apr/25/dual-llm-pattern/[The Dual LLM pattern for building AI assistants that can resist prompt injection]
...
[#gpt-4-launch]
== 2023-03-14 link:https://openai.com/index/gpt-4-research/[GPT‑4]

Company: OpenAI +
Headquarters: San Francisco, California, U.S. +
Previous: <<gpt-3-5-launch>>

[#chatgpt-plus-launch]
== 2023-03-03 link:https://en.wikipedia.org/wiki/ChatGPT#Model_versions[ChatGPT release]

Company: OpenAI +
Headquarters: San Francisco, California, U.S. +
Previous: <<chat-gpt-launch>>

* Based on <<gpt-4-launch>>

== 2023-02-24 link:https://en.wikipedia.org/wiki/Llama_(language_model)[Meta LLaMA is announced]

== 2023-02-21 link:https://arxiv.org/abs/2302.10866[Hyena Hierarchy: Towards Larger Convolutional Language Models]

* the core building block of Transformers, the attention operator, exhibits quadratic cost in sequence length, limiting the amount of context accessible.
* In this work, we propose Hyena, a subquadratic drop-in replacement for attention constructed by interleaving implicitly parametrized long convolutions and data-controlled gating.
...
== 2022-09-12 link:https://simonwillison.net/2022/Sep/12/prompt-injection/[Prompt injection attacks against GPT-3]
Author: Simon Willison
...
== 2022-08-01 link:https://arxiv.org/abs/2208.00748[Efficient Long-Text Understanding with Short-Text Models]
...
* In this work, we propose *SLED*: SLiding- Encoder and Decoder, a simple approach for processing long sequences that re-uses and leverages battle-tested short-text pretrained LMs.
* Specifically, we partition the input into overlapping chunks, encode each with a short-text LM encoder and use the pretrained decoder to fuse information across chunks (fusion-in-decoder).
...
* [Based on the Codex version of <<gpt-3-0-launch, GPT-3>>]

== 2022-05-27 link:https://arxiv.org/abs/2205.14135[FlashAttention: Fast and Memory-Efficient Exact Attention with IO-Awareness]
...
[#gpt-3-5-launch]
== 2022-03-15 link:https://en.wikipedia.org/wiki/GPT-3#GPT-3.5[GPT 3.5]

Company: OpenAI +
Headquarters: San Francisco, California, U.S. +
Previous: <<gpt-3-0-launch>>

== 2022-01-28 link:https://arxiv.org/abs/2201.11903[Chain-of-Thought Prompting Elicits Reasoning in Large Language Models]
Authors: Google Research, Brain Team

* We explore how generating a chain of thought—a series of intermediate reasoning steps—significantly improves the ability of large language models to perform complex reasoning.
* In particular, we show how such reasoning abilities emerge
naturally in sufficiently large language models via a simple method called chain-of-thought prompting, where a few chain of thought demonstrations are provided as exemplars in prompting.

== 2021-08-16 link:https://arxiv.org/abs/2108.07258[On the Opportunities and Risks of Foundation Models]
...
Paper seems to be the origin of the term "foundation model".

== 2021-03-03 link:https://www.semanticscholar.org/paper/On-the-Dangers-of-Stochastic-Parrots%3A-Can-Language-Bender-Gebru/ca2f1088d3e581b2c6c75cf0ebc96506d620f64d[On the Dangers of Stochastic Parrots: Can Language Models Be Too Big?]

* The past 3 years of work in NLP have been characterized by the
development and deployment of ever larger language models, especially for English. BERT, its variants, GPT-2/3, and others, most recently Switch-C, have pushed the boundaries of the possible both through architectural innovations and through sheer size.
* In this paper, we take a step back and ask: How big is too big? What are the possible risks associated with this technology and what paths are available for mitigating those risks?
* We first consider environmental risks. [...] As we outline in §3, increasing the environmental and financial costs of these models doubly punishes marginalized communities that are least likely to benefit from the progress achieved by large LMs and most likely to be harmed by negative environmental consequences of its resource consumption.
* Just as environmental impact scales with model size, so does the difficulty of understanding what is in the training data. In §4, we discuss how large datasets based on texts from the Internet overrepresent hegemonic viewpoints and encode biases potentially damaging to marginalized populations.
* Furthermore, the tendency of human interlocutors to impute meaning where there is none can mislead both NLP researchers and the general public into taking synthetic text as meaningful.
...
[#gpt-3-0-launch]
== 2020-05-28 link:https://arxiv.org/abs/2005.14165[Language Models are Few-Shot Learners]

Previous: <<gpt-2-launch>>
...
== 2020-01-23 link:https://arxiv.org/abs/2001.08361[Scaling Laws for Neural Language Models]

[#gpt-2-launch]
== 2019 link:https://cdn.openai.com/better-language-models/language_models_are_unsupervised_multitask_learners.pdf[Language Models are Unsupervised Multitask Learners]

Previous: <<gpt-1-launch>>
...
== 2019-06 link:https://aclanthology.org/N19-1423/[BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding]

== 2019-01-09 link:https://arxiv.org/abs/1901.02860[Transformer-XL: Attentive Language Models Beyond a Fixed-Length Context]

* We introduce a new language representation model called *BERT*, which stands for Bidirectional Encoder Representations from Transformers.

[#deep-learning-critical-appraisal]
== 2018-01-02 link:https://arxiv.org/abs/1801.00631[Deep Learning: A Critical Appraisal]
Author: Gary Marcus
...
** Such systems are commonly described as neural networks because the input nodes, hidden nodes, and output nodes can be thought of as loosely analogous to biological neurons, albeit greatly simplified
...
** systems that rely on deep learning frequently have to **generalize beyond the specific** data that they have seen, whether to a new pronunciation of a word or to an image that differs from one that the system has seen before.
** generalization can be thought of as coming in two flavors, _interpolation_ between known examples, and _extrapolation_, which requires going beyond a space of known training examples

* Here are ten [concerns] faced by current deep learning systems:
** *Concern 1*: Deep learning thus far is data hungry
*** Human beings can learn abstract relationships in a few trials. [...] even 7-month old infants can do so, acquiring learned abstract language-like rules from a small number of unlabeled examples, in just two minutes [...]
...
** *Concern 2*: Deep learning thus far is shallow and has limited capacity for transfer
*** it is important to realize that the word “deep” in deep learning refers to a technical, architectural property (the large number of hidden layers used in a modern neural networks, where there predecessors used only one) rather than a conceptual one
*** [the system] doesn’t really understand what a tunnel, or
what a wall is; it has just learned specific contingencies for particular scenarios.
*** the patterns extracted by deep learning are more superficial than they initially appear.
** *Concern 3*: Deep learning thus far has no natural way to deal with hierarchical structure
*** deep learning learns correlations between sets of features that are themselves “flat” or nonhierachical, as if in a simple, unstructured list, with every feature on equal footing.
*** Hierarchical structure  are not inherently or directly represented in such systems
** *Concern 4*: Deep learning thus far has struggled with open-ended inference
*** [systems have less sucess] in tasks in which inference goes beyond what is explicit in a text, either by combining multiple sentences (so called multi-hop inference) or by combining explicit sentences with background knowledge that is not stated in a specific text selection.
*** Humans, as they read texts, frequently derive wide-ranging inferences that are both novel and only *implicitly licensed*, as when they, for example, *infer the intentions* of a character based only on indirect dialog.
** *Concern 5*: Deep learning thus far is not sufficiently transparent
...
** *Concern 6*: Deep learning thus far has not been well integrated with prior knowledge
*** Problems that have less to do with categorization and more to do with commonsense reasoning essentially lie outside the scope of what deep learning is appropriate for
*** people can readily answer [the following] without anything like direct training: _Who is taller, Prince William or his baby son Prince George? Can you make a salad out of a polyester shirt? If you stick a pin into a carrot, does it make a hole in the carrot or in the pin?_
** *Concern 7*: Deep learning thus far cannot inherently distinguish causation from correlation
*** Roughly speaking, deep learning learns complex correlations between input and output features, but with no inherent representation of causality.
*** _kids get bigger as they learn more words, but that doesn’t mean that growing tall causes them to learn more words, nor that learning new words causes them to grow_
** *Concern 8*: Deep learning presumes a largely stable world, in ways that may be problematic
** *Concern 9*: Deep learning thus far works well as an approximation, but its answers often cannot be fully trusted
*** deep learning systems are quite good at some large fraction of a given domain, yet easily fooled
*** mistaken yellow-and-black patterns of stripes for school buses
*** real-world stop signs, lightly defaced, that have been mistaken for speed limit signs
*** 3d-printed turtles that have been mistaken for rifles
** *Concern 10*: Deep learning thus far is difficult to engineer with
*** machine learning as yet lacks the incrementality, transparency and debuggability of classical programming, trading off a kind of simplicity for deep challenges in achieving robustness

* Discussion
** deep learning is just a statistical technique, and all statistical techniques suffer from deviation from their assumptions.
...
** If, for example, driverless car should also, disappoint, relative to their early hype, by proving unsafe when rolled out at scale, or simply not achieving full autonomy after many promises, the whole field of AI could be in for a sharp downturn, both in popularity and funding.
...
[#gpt-1-launch]
== 2018 link:https://cdn.openai.com/research-covers/language-unsupervised/language_understanding_paper.pdf[Improving Language Understanding by Generative Pre-Training]

Company: OpenAI +
Headquarters: San Francisco, California, U.S.

* Although large unlabeled text corpora are abundant,
labeled data for learning these specific tasks is scarce, making it challenging for discriminatively trained models to perform adequately.
...
A Google paper that lays the foundation (transformer architecture) upon which all generative AI tools are based on.

== 2014-09-01 link:https://arxiv.org/abs/1409.0473[Neural Machine Translation by Jointly Learning to Align and Translate]
...
Origin of the attention-mechanism. Rather than compressing the input into a fixed-length vector, the model revisits the input at every step.
