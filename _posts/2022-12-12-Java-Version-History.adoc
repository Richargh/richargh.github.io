...
* link:https://openjdk.org/projects/jdk/22/[22] (expected March 2024) *LTS* until September 2028
** _Preliminary opinion_, since JDK rampdown and feature set freeze won't happen before January.
*** This could be the release that finally delivers link:https://openjdk.org/jeps/401[Primitive Classes Preview] and link:https://openjdk.org/jeps/8277163[Value Objects Preview]. It might also finalize String templates.
